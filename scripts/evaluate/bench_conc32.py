...
def run_subset(target, subset, concurrency, max_requests, tmpdir):
    ...
    # NOTE: median of output_tokens_per_second is a per-interval rate that understates aggregate.
    ...
    return {
        ...
        "output_tok_mean": round(statistics.mean(out_tok), 1) if out_tok else "",
...
def main():
    ...
    cols = ["subset", "n_req", "input_tok_median", "output_tok_mean",
